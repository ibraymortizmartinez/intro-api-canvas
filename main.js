...
function draw_rectangulo() {
    ...
    if (canvas.getContext) {
      ...
      ctx.fillRect(25, 25, 100, 100);  // Rectángulo relleno
      ctx.clearRect(45, 45, 60, 60);   // Limpia parte del rectángulo
      ctx.strokeRect(50, 50, 50, 50);  // Contorno de rectángulo
    }
  }  
  ...
  function draw_curvas_cuadraticas_bezier() {
    const canvas = document.getElementById('curvas_cuadraticas');
    if (canvas.getContext) {
        const ctx = canvas.getContext("2d");
  ...
  function draw_curvas_cubicas_bezier() {
    const canvas = document.getElementById("curbas_cubicas");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  // Función para combinar líneas y figuras
  ...
  // Ejecutar todas las funciones para dibujar en cada canvas
  function drawAll() {
    draw_rectangulo();
    draw_triangulo();
    draw_pluma();
  ...
  // Llama a todas las funciones cuando la página se carga
